...
import { EnrollmentsTableComponent } from '../../theme/shared/components/enrollments-table/enrollments-table.component';
...
@Component({
  ...
  imports: [SharedModule, RouterLink, EnrollmentsTableComponent],
