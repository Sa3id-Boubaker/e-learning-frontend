...
export class CourseEnrollmentFormModalComponent extends StudentSearchFormBase implements OnChanges, OnDestroy {
  ...
  submit(): void {
    ...
    submitEnrollment(this, (studentId) => this.enrollmentService.createEnrollment(studentId, courseId));
  }
